...
| plot_curves.py -xy -l=None -logx -nomarkers -lw=1.3 -minx=0.0008 -maxx=1800 -miny=0.6 -maxy=1.004 \
...
plot_1v1.py ._ -l='Running time of seq. \textsc{Lilotane} [s]' data/qtimes-mallotane-2348cores-30min -l='Running time of \textsc{Mallotane} [s]' \
